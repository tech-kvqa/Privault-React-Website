...
const Grainient: React.FC<GrainientProps> = ({
  ...
  useEffect(() => {
    // If reduced motion is preferred, bypass WebGL context creation entirely
  ...
  useEffect(() => {
    ...
    prefersReducedMotion, timeSpeed, colorBalance, warpStrength, warpFrequency, warpSpeed,
  ...
  if (prefersReducedMotion) {
    return (
      <div 
        ...
        style={{
          background: `linear-gradient(135deg, ${color1} 0%, ${color3} 50%, ${color2} 100%)`
        }}
      />
    );
  }
